        ...
        private void cmdExecute_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (isOK == true)
                {
                    ...
                    this.Hide();
                    FormBuilder.buildSelectedService(args, rsps, serviceName, serviceTeamName, serviceDescription, serviceIPString, servicePortString, teamName, teamID, expiration, ipString, portString, frmService);
                }
                else if (isOK == false)
                {
